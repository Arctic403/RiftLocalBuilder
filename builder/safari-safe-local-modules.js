const MODULES=[
  ...
  {name:'Autonomous Visual QA',slot:'#autonomous-slot',loader:'./autonomous-visual-local-adaptive-loader.js?v=h2.28-1',base:'./autonomous-visual-inspector.js?v=h2.15-1'}
];
